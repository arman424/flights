...
class UpdateFlightRequest extends FormRequest
{
    ...
    public function messages(): array
    {
        return [
            ...
            'legs.required'                                  => 'At least one leg must be provided.',
    ...
    public function toDto(string $flightId): UpdateFlightDTO
    {
        return UpdateFlightDTO::fromValidated($flightId, $this->validated());
    }
}
